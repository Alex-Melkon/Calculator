...
const allClearButton = document.querySelector('[data__all--clear]');
const previousOperandTextElement = document.querySelector('[data__previous--operand]');
const currentOperandTextElement = document.querySelector('[data__current--operand]');
